        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-20">
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 text-white/90 text-sm md:text-base">
              ...
              <span>/</span>
              <span className="text-orange-400 font-semibold">Sứ mệnh</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <article className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 md:p-8 space-y-4">
              ...
              <p className="text-sm md:text-base leading-relaxed text-gray-700">
                Mang đến giá trị bền vững cho khách hàng thông qua các sản phẩm công nghệ
                chất lượng, sáng tạo và an toàn.
              </p>
              <p className="text-sm md:text-base leading-relaxed text-gray-700">
                Chúng tôi luôn đặt khách hàng làm trung tâm, nỗ lực hiểu rõ nhu cầu thực tế
                để xây dựng nên những giải pháp phù hợp, hiệu quả và dễ triển khai trong môi
